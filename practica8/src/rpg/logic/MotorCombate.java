...
public class MotorCombate {
    ...
    /*public void iniciarCombate(Personaje jugador1, Personaje jugador2){
        ...
        do {
            ...
            System.out.println("Eres un "+jugador1.getRaza().getNombre()+"-"+jugador1.getClase().getNombre());
            System.out.println(jugador1.getNombre()+" "+jugador1.getEstadisticas().getVida()+"/"+ jugador1.getEstadisticas().getVidaMaxima()+"HP");
            System.out.println("-------------------------------------------------|");
            System.out.println("JUGADOR 2");
            System.out.println("Eres un "+jugador2.getRaza().getNombre()+"-"+jugador2.getClase().getNombre());
